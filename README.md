...
A machine learning project for digital forensics that classifies PDF documents based on their source application using metadata analysis. This system can identify whether a PDF was generated by Microsoft Word, Google Docs, LaTeX, Python/ReportLab, or HTML conversion with up to 95% accuracy.
...
- 95% accuracy on 4-class classification
...
|-----------|-----------------|---------------|------------|
| **XGBoost** | 95% | Balanced performance across all classes | Minimal |
| **Random Forest** | 95% | Excellent generalization | Minimal |
| **SVM** | 94% | Perfect Google Docs classification | Poor recall for HTML & Google Docs PDF |
| **SGD** | 92% | Fast training | High confusion between Word, Python, and LaTeX |
